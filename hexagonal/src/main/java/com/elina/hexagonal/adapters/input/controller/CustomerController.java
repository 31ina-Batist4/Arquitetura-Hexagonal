package com.elina.hexagonal.adapters.input.controller;

import com.elina.hexagonal.adapters.input.controller.mapper.CustomerMapper;
...
public class CustomerController {
    ...
    public ResponseEntity<Void> insert(@Valid  @RequestBody CustomerRequest customerRequest) {
       var customer = customerMapper.toCustomer(customerRequest);
        insertCustomerInputPort.insert(customer, customerRequest.getZipeCode());
    ...
    public ResponseEntity<Void> update(
        ...
        customer.setId(id);
        updateCustomerInputPort.update(customer, customerRequest.getZipeCode());
        return ResponseEntity
                .noContent()
                .build();
    }
